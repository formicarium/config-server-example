(ns config-server-example.components.api.config-server-example-api
  (:require [com.stuartsierra.component :as component]
            [config-server-example.protocols.config.config :as p-cfg]
            [schema.core :as s]
...
(defrecord ConfigServerExampleApi [service-map service]
  component/Lifecycle
  (start [this]
    (if service
      this
...
(defn new-config-server-example-api []
  (map->ConfigServerExampleApi {}))
